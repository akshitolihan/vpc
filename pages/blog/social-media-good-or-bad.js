      ...
      <section className="flex justify-center flex-wrap md:flex-nowrap md:bg-[#F8F9FA] ">
        <section className="w-auto flex justify-center bg-white rounded-xl shadow-lg my-10">
          <section className="m-0 md:m-10 rounded-3xl text-black lg:w-[900px] ">
            ...
            <h1 className="flex justify-center text-4xl font-bold p-0 md:px-4 pt-4">
            ...
            <div className="pt-10" style={{ fontFamily: "Georgia serif" }}>
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                There is not any clearcut answer to this question. We can
                consider the good or the bad things about social media. In this
                article, we will be having a view on that.
              </p>
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                Social media has its pros and cons as other things have. In the
                past 10 years, our lives have changed to a great extent and we
                can say that our lifestyle is changing constantly. Social media
                is one of the greatest changes we have seen in past years.
                Nowadays we have several social media apps and websites
                available where people can connect with other people and
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                provide some kind of tool for the user to interact with other
                people on that platform. We can see social media sharing
                platforms like Instagram, Youtube, Facebook, Twitter, etc. They
                all are kind of the same as well as we can say that they provide
                features differently from each other and that is the reason why
                they are surviving instead of having these so many apps.
              </p>
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                etc. as they can use this platform to stream their videos live.
              </p>
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                We have Facebook and Instagram where you have a public profile
                and you can share your thoughts, and content, make friends and
                follow your friends and celebrities. You can create groups,
                rooms, and pages to share anything you want to share. These are
                the two platforms where you can do multiple things. You can
                become an influencer on Instagram. You can share photos, reels,
                videos, etc. on Instagram.
              </p>
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                apps are providing opportunities for people to showcase their
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                together for a cause, or to solve a problem and contribute to
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                earn a lot amount of money. You can begin by creating an account
                on all these apps.
              </p>
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                competition available in their fields. This is because they are
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                connect to the world online with a single click thing. You can
                ...
                career on that. You can follow the pages, and join the groups of
                the people and the organizations you are interested in. You can
                follow some educational pages, financial pages, and news pages
                to get updated and informed. You can chat with your friends and
                can share your photos and videos on these platforms.
              </p>
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                the home of rumours and many rumours have serious repercussions.
              ...
              <p className="flex justify-start text-justify text-2xl font-normal text-[#191919] px-3 pt-4 md:px-14">
                ...
                point on every issue. It provides you with knowledge about
                nature, wildlife, lifestyle, culture, languages, etc. due to the
            ...
            <button
              id={navbar.font}
              type="button"
              className="text-3xl no-underline text-[#2F4858] font-extrabold justify-center  mt-4 w-auto  rounded-t-[50px]  rounded-r-[50px] m-auto block "
            >
