      ...
      <section className="flex justify-center md:bg-[#F8F9FA] p-8">
        <section className="shadow-lg rounded-lg bg-white max-w-[900px] p-8">
          {/* <p>
              ...
              soluta maxime! Fuga rerum quidem, itaque voluptas praesentium
              doloribus odio! Quas obcaecati aliquid odit. Adipisci harum illo
              tempora quia excepturi consequuntur, quam dolores voluptatem
              officiis asperiores, incidunt est corporis ea cumque alias
              laboriosam. Harum molestias consequuntur voluptatem optio quisquam
              expedita officiis quia quas sunt saepe placeat repellat, commodi
              iusto eum ducimus veritatis dignissimos asperiores reprehenderit
              cupiditate magnam? Fugit aliquam provident id tempora voluptatibus
              officiis minus fuga commodi, optio hic nemo quas libero debitis
              voluptas dignissimos tempore repudiandae labore ut reprehenderit
